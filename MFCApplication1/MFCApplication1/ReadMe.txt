...
MFCApplication1Doc.h, MFCApplication1Doc.cpp - 문서
    ...
    문서에는 다음과 같은 문자열이 있습니다.
        파일 확장명:      cpp
        파일 형식 ID:        MFCApplication1.Document
        주 프레임 캡션:  MFCApplication1
        Doc 형식 이름:       MFCApplication1
        필터 이름:         MFCApplication1 Files (*.cpp)
        파일의 새 약식 이름: MFCApplication1
        파일 형식의 긴 이름: MFCApplication1.Document
